...
Behind the wheel classes are held in pairs. Two students and the teacher. Total of 3 persons.  Masks and gloves are required. We can provide you some if needed. At the end of a lesson, the car is sanitized before it is used for another session. Cars are rotated during the week. 

For the classroom - classes are being conducted with under 9 students. For the safety of our clients, Abigail´s Driving School is offering private sessions 7 days a week, based on availability for the driver improvement and re-examination class. There are reasonable spaces between clients during class. 

We provide sanitizers, masks and gloves in the office - if the client requires. 
...
No we do not, however, payment decisions are made on an individual basis. We require $50 non-refundable deposit when you register to hold your spot. Also, we require at minimum of 50% of remaining balance on the first day of class.
